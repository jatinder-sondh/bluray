jQuery(document).ready(function() {
    ...
    jQuery('form.contact_1', '.contact_form_1').on('submit', function( e ){
        ...
        if ($form.find('#contact_form_phone', '.contact_form_1').hasClass('error_fields_class')) {
            jQuery($form).find('div.result', '.contact_form_1').attr('disabled', false).append('<p class="error_item">The phone can\'t be empty</p>');
        };
