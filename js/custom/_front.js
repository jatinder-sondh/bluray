...
function ready() {
	...
	jQuery('.widgetWrap ul > li.dropMenu,.panelmenu_area ul > li.dropMenu,.widgetTop ul > li.dropMenu').on('click', function (e) {
		"use strict";
	...
	// Open sidemenu
	jQuery('.sidemenu_button, #sidemenu_button').on('click', function (e) {
		"use strict";
...
function calcMenuColumnsWidth() {
	...
	jQuery('#mainmenu li.custom_view_item ul.menu-panel ul.columns').each(function() {
		...
		jQuery(this).find('>li').css('height', 'auto').each(function () {
			...
			if (h < mh) h = mh;
			var bl = parseInt(li.css('borderLeft'),0), pl = parseInt(li.css('paddingLeft'),0), br = parseInt(li.css('borderRight')), pr = parseInt(li.css('paddingRight'),0);
